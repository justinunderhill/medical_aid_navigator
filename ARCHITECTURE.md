...
`AI_PROVIDER`. Anthropic is the default because it adheres more reliably to the
refusal/guardrail instructions that protect us from claim guarantees and medical
advice. The rest of the app never knows which provider is active.
